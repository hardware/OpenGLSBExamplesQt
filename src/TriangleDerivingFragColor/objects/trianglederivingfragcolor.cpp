#include "trianglederivingfragcolor.h"
 ...
 */
TriangleDerivingFragColor::TriangleDerivingFragColor(QObject *parent)
    : AbstractScene(parent),
      m_vao(new QOpenGLVertexArrayObject(this)),
      m_logger(new QOpenGLDebugLogger(this))
{}

TriangleDerivingFragColor::~TriangleDerivingFragColor()
{
    m_vao->destroy();
    m_shaderProgram.release();
}

void TriangleDerivingFragColor::initialize()
{
...
void TriangleDerivingFragColor::update(float t)
{
    Q_UNUSED(t);
}

void TriangleDerivingFragColor::render(double currentTime)
{
...
void TriangleDerivingFragColor::resize(int width, int height)
{
    glViewport(0, 0, width, height);
}

void TriangleDerivingFragColor::prepareShaderProgram()
{
...
void TriangleDerivingFragColor::onMessageLogged(QOpenGLDebugMessage message)
{
    qDebug() << message;
}
